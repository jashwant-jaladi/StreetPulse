...
useEffect(() => {
  ...
  return (
    ...
    {perPage.map((item) =>
        ...
        <h2 className='pt-3 pl-3 text-2xl font-bold text-yellow-400 cursor-pointer'><Link href={'/blogs/'+item._id} rel="noopener noreferrer" target="_blank">{item.title}</Link></h2>
