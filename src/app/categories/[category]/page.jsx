...
const CategoryPage = ({ params }) => {
  ...
  return (
    <div>
      <Shopnav onFilterChange={setSelectedFilter} />
      <div className="bg-black text-slate-300 p-4 sm:p-14 pt-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 sm:gap-14 place-items-center">
